...
Section.prototype = {
    ...
    setAsSuccess: function(results) {
        ...
        if (this._parent && this._parent.status === 'fail') {
            return this._parent.setAsSuccess();
        }

        if (this._parent) {
            this._parent._setAsSuccessIfAllChildSuccess();
        }
    },
    ...
    _setAsSuccessIfAllChildSuccess: function() {
        var notSuccessChild = this.domNode.querySelector('.section:not(.' +  statusClass('success') + ')');
        if (notSuccessChild) {
            return;
        }

        // if all childs are success
        this.setAsSuccess();
    },
